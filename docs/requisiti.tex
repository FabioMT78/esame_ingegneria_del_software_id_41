...
\begin{itemize}
    ...
    \item Alla registrazione definitiva del contratto la prima mensilità si considera
          già versata e il sistema deve creare e memorizzare il relativo pagamento con data
          coincidente con la data di decorrenza del contratto. Le successive registrazioni
          di pagamento della versione 1.0 riguardano pertanto le mensilità successive alla prima.
    \item Ogni pagamento appartiene a un solo contratto e si riferisce a una sola mensilità.
          Per ciascuna mensilità di un contratto può esistere al massimo un pagamento.
    ...
    \item Non sono ammessi pagamenti parziali del canone di locazione; il relativo importo
          deriva dal canone mensile previsto nel contratto.
...
ufficiale presso l'Agenzia delle Entrate. Alla registrazione definitiva del contratto il
sistema deve inoltre creare e memorizzare il pagamento della prima mensilità con data
coincidente con la data di decorrenza del contratto. \\
...
\textbf{allora} il contratto deve essere registrato e il sistema deve creare e memorizzare
il pagamento della prima mensilità con data coincidente con la data di decorrenza del contratto.
...
\paragraph{AC-13 -- Importo del pagamento}
...
\textbf{allora} il pagamento deve essere registrato;
