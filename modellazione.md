...
`Contratto` espone i comportamenti di dominio necessari ai casi d'uso, fra cui definizione e confronto dei periodi, calcolo di importo e scadenza delle competenze, impostazione del contenuto e aggiunta dei Pagamenti. Il significato della sovrapposizione resta nel dominio; il repository può offrire una ricerca mirata per verificare efficientemente se un periodo sovrapposto esiste nei dati persistiti.
